    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <section className="py-20">
          <div className="max-w-[1500px] mx-auto px-8">
            <div className="mb-12">
              <div className="font-mono text-[15px] font-medium tracking-[0.08em] text-muted-foreground uppercase mb-3">Where we&apos;re heading</div>
              <p className="text-[19px] text-muted-foreground max-w-[680px]">The outcomes we&apos;re building toward with our early audit partners.</p>
            </div>
